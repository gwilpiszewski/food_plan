...
recipeplan1 = RecipePlan.objects.create(meal_name=1, recipe=r4, plan=p1, order=1, day_name=d1)
recipeplan2 = RecipePlan.objects.create(meal_name=2, recipe=r1, plan=p1, order=2, day_name=d1)
recipeplan3 = RecipePlan.objects.create(meal_name=3, recipe=r6, plan=p1, order=3, day_name=d1)
recipeplan4 = RecipePlan.objects.create(meal_name=1, recipe=r2, plan=p1, order=1, day_name=d2)
recipeplan5 = RecipePlan.objects.create(meal_name=3, recipe=r4, plan=p1, order=2, day_name=d2)
recipeplan6 = RecipePlan.objects.create(meal_name=5, recipe=r5, plan=p1, order=3, day_name=d2)
recipeplan7 = RecipePlan.objects.create(meal_name=1, recipe=r3, plan=p1, order=1, day_name=d4)
recipeplan8 = RecipePlan.objects.create(meal_name=2, recipe=r2, plan=p1, order=2, day_name=d4)
recipeplan9 = RecipePlan.objects.create(meal_name=4, recipe=r1, plan=p1, order=3, day_name=d4)

recipeplan10 = RecipePlan.objects.create(meal_name=1, recipe=r2, plan=p2, order=1, day_name=d1)
recipeplan11 = RecipePlan.objects.create(meal_name=3, recipe=r3, plan=p2, order=3, day_name=d1)
recipeplan13 = RecipePlan.objects.create(meal_name=1, recipe=r1, plan=p2, order=3, day_name=d3)
recipeplan14= RecipePlan.objects.create(meal_name=3, recipe=r2, plan=p2, order=2, day_name=d3)
recipeplan15 = RecipePlan.objects.create(meal_name=5, recipe=r6, plan=p2, order=1, day_name=d3)
recipeplan16 = RecipePlan.objects.create(meal_name=1, recipe=r2, plan=p2, order=2, day_name=d5)
recipeplan18 = RecipePlan.objects.create(meal_name=5, recipe=r3, plan=p2, order=1, day_name=d5)

recipeplan19 = RecipePlan.objects.create(meal_name=1, recipe=r1, plan=p3, order=1, day_name=d1)
recipeplan20 = RecipePlan.objects.create(meal_name=3, recipe=r2, plan=p3, order=3, day_name=d1)
recipeplan21 = RecipePlan.objects.create(meal_name=1, recipe=r5, plan=p3, order=3, day_name=d3)
recipeplan22= RecipePlan.objects.create(meal_name=3, recipe=r4, plan=p3, order=2, day_name=d3)
recipeplan23 = RecipePlan.objects.create(meal_name=5, recipe=r2, plan=p3, order=1, day_name=d3)
recipeplan24 = RecipePlan.objects.create(meal_name=1, recipe=r6, plan=p3, order=2, day_name=d5)
recipeplan25 = RecipePlan.objects.create(meal_name=5, recipe=r1, plan=p3, order=1, day_name=d5)